...
# target_dict
# cols = ['KNClassifier', 'LogisticRegression L1', 'LogisticRegression L2',
#        'SVM L1', 'SVM L2', 'SVC Poly', 'SVC RBF']
...
# return ['XG Boost', round(clf_xgb.best_score_*100, 2), 
#         round(xgb_score*100, 2), clf_xgb.best_params_]
```
